...
console.log(" ");
console.log("------------------ 5-Nov-2022 Assignment No.3 ---------------------");
console.log(" ");
console.log("--------------  Map details using forEach() loop ------------------");
console.log(" ");
// let setOfKeys = map_employees.keys();
// for (const key of setOfKeys) {
//     console.log(`  ${key} ===> Name: ${map_employees.get(key).emp_name},  Dept: ${map_employees.get(key).emp_dept},  Company: ${map_employees.get(key).emp_company},  Salary: ${map_employees.get(key).emp_salary}`);
// }
